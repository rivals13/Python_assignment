...
def validate_user_details(
    ...
    if email in user_emails:
        errors.append("Error: User email already exists!")
    if email in admin_emails:
        errors.append("Error: Email already registered as admin!")
    if email in staff_emails:
        errors.append("Error: Email already registered as staff!")
    if email.isdigit():
    ...
    if contact_number in staff_contact:
        errors.append("Error: Contact number already registered!")
    ...
    if citizenship_number in staff_citizenship:
        errors.append("Error: Citizenship number already registered!")
    ...
    # validating the email address of the new user
    ...
    if contact_number in staff_contact or contact_number in user_contact:
        errors.append("The contact number already exists!")
